class DangerEngine
  ...
  def rating_quote
    case score
    when 0..20 then "On March 3, 1969 the United States navy established an elite school for the top one percent of it's drivers.  The drivers call it TOP GUN DRIVER!"
    when 21..40 then 'Is this your idea of fun MAN?'
    when 41..60 then 'Top drivers rules of engagement are written for you safety.  They are not flexible. Nor am I. Either obey them or you are histor. Is that clear!'
